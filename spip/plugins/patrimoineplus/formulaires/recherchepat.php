 ...
 * @return array
 */
function formulaires_recherchepat_charger_dist($lien = '', $class = '') {
	...
	$action = ($lien ? $lien : generer_url_public('recherchepat')); # action specifique, ne passe pas par Verifier, ni Traiter
	return
		array(
			'action' => $action,
