 ...
 * @return array
 */
function formulaires_filtrer_charger_dist(){
 ...
 * @return array
 */
function formulaires_filtrer_verifier_dist(){
	$erreurs = array();
	if (_request('cancel')){
 ...
 */
function formulaires_filtrer_traiter_dist(){
	return array(
		'message_ok'=>('Bravo, c\'est une reussite !'),
		'editable'=>true
	);
}
